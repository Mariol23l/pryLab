$(document).ready(function () {
            ...
            usuarios.forEach(usuario => {
              ...
              <div class="card bg-light d-flex flex-fill">
                  ...
                  <div class="row">
                    <div class="col-7">
                      ...
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-fa-birthday-cake"></i></span> Edad: ${usuario.edad}</li>
                ...
                if (tipo_usuario == 3) {
                    if (usuario.tipo_usuario != 3) {
                        template += `
                          <button class="borrar-usuario btn btn-danger ml-1 mt-1" type="button" data-toggle="modal" data-target="#confirmar">
                        <i class="fas fa-window-close mr-1 mb-1"></i>Eliminar
                    </button>
                    `;
                    }
                    if (usuario.tipo_usuario == 2) {
                        template += `
                        <button class="ascender btn btn-primary ml-1 mt-1" type="button" data-toggle="modal" data-target="#confirmar">
                      <i class="fas fa-sort-amount-up mr-1 mb-1"></i>Ascender
                        </button>
                  `;
                    }
                    if (usuario.tipo_usuario == 1) {
                        template += `
                        <button class="descender btn btn-secondary ml-1 mt-1" type="button" data-toggle="modal" data-target="#confirmar">
                      <i class="fas fa-sort-amount-down mr-1 mb-1"></i>Descender
                        </button>
                  `;
                    }
                } else {
                    if (tipo_usuario == 1 && usuario.tipo_usuario != 1 && usuario.tipo_usuario != 3) {
                        template += `
                        <button class="borrar_usuario btn btn-danger" type="button" data-toggle="modal" data-target="#confirmar">
    ...
    //evento para ver que se teclea en el input
    ...
    $('#form-crear').submit(e => {
        ...
        $.post('../controlador/UsuarioController.php', { nombre, apellido, edad, dni, pass, funcion }, (reponse) => {
            if (reponse == 'add') {
                $('#add').hide('slow');
                $('#add').show(1000);
                $('#add').hide(2000);
