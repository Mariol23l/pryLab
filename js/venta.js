    ...
    $('#tabla_venta tbody').on('click', '.borrar', function () {
        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            title: 'Esta seguro que desea eliminar la venta registrada a nombre de la Clinica: ' + razsocial + '?',
              ...
              if (result.isConfirmed) {
                  $.post('../controlador/DetalleVentaController.php', { funcion, id }, (response) => {
                      ...
                      if (response.includes('nodelete')) {
                        ...
                        swalWithBootstrapButtons.fire(
                            'Eliminado!',
                            'La venta: '+id+' Registrada a nombre de la Clinica '+razsocial+' ha sido eliminada',
                            'success'
                      )
                      }
                }) 
        ...
        $.post('../controlador/VentaProductoController.php', { funcion, id }, (response) => {
            ...
            registros.forEach(registro => {
                template += `
                    ...
                    <td><b>${registro.nombre}${registro.concentracion} LOTE:${registro.lote} F.VEN:${registro.vencimiento}</b></td>                   
