    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <span>Ingresar password para Continuar</span>
                <div class="alert alert-success text-center" id="confirmado" style='display: none;'>
                    <span><i class="fas fa-check m-2"></i>Se modifico al Usuario</span>
                </div>
            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    <div class="alert alert-success text-center" id="add" style='display: none;'>
                        <span><i class="fas fa-check m-2"></i>Se agrego correctamente el Usuario</span>
                    </div>
                    ...
                    <form id="form-crear">
                        ...
                        <div class="form-group">
                            ...
                            <input id="edad" type="date" class="form-control" placeholder="Ingrese fecha nacimiento"
                                required>
                        </div>
                        <div class="form-group">
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gestion Usuarios <button id="button-crear" type="button" data-toggle="modal"
                            data-target="#crearusuario" class="btn bg-gradient-blue ml-2">
                            Crear Usuario<i class="fas fa-solid fa-user-plus ml-2"></i></button></h1>
            ...
            <div class="card card-lightblue">
                <div class="card-header">
                    ...
                    <div class="input-group">
                        <input id="buscar" placeholder="Ingrese nombre de Usuario" type="text"
